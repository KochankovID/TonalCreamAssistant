...
(
    ...
    CONSTRAINT vendor_vendor_pkey PRIMARY KEY
(
    id
)
    );
...
(
    ...
    CONSTRAINT vendor_product_pkey PRIMARY KEY
(
    id
),
    CONSTRAINT vendor_product_vendor_id_fk_vendor_vendor_id FOREIGN KEY
(
    vendor_id
)
